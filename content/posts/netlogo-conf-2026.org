...
You can learn all about NetLogo [[https://www.netlogo.org/][here]] but in short, it can be described as a modelling language or a language where you can explore asynchronous agent based programming (that's a mouthful and sounds impressive but it's really strightforwad).
